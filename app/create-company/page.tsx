                        ...
                        {companies.map((company) => (
                            <li key={company.id} className='py-4 flex flex-col md:flex-row md:items-center justify-between'>
                                ...
                                <div className='flex items-center'>
                                    <Link href={`employees/${company.id}`} className='btn mr-2 btn-sm btn-outline btn-secondary'>
                                        Ajouter des employés
                                    </Link>
                                    <Link href={`rooms/${company.id}`} className='btn mr-2 btn-sm btn-outline btn-secondary'>
                                        Ajouter des salles
                                    </Link>
                                    <button
